...
window.onload = function() {
    ...
    if (botaoCarregar) {
        ...
        //    xhr.addEventListener("readystatechange", () => {
            ...
            fetch(url)
            .then(resposta => resposta.json())//controlar o fluxo de informação
            .then(dados => {
                    for(let item in dados) {
                        ...
                        tabela.tBodies[0].appendChild(linha); //adicionandoo a linha no tbody da tabela no primeiro termo = 0
